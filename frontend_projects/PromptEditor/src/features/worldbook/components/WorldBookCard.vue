  ...
  <div
    ...
    <div v-else class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div v-if="form.mode === 'conditional'" class="md:col-span-2">
        ...
        <input v-model="form.keysText" placeholder="示例：艾拉;工程师" class="w-full px-3 py-2 border border-gray-300 rounded-4 focus:outline-none focus:ring-2 focus:ring-gray-800" />
      </div>
