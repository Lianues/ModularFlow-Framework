...
const initialCharacterData = {
  name: '演示角色 - 完整示例',
  description: '这是一个演示用的角色卡，包含完整的基本信息、初始消息、世界书和正则规则。可以进行编辑、新增、删除等所有操作。',
  message: [
    '你好，我是演示角色。这是第一条初始消息，用于展示消息列表的功能。',
    '这是第二条初始消息，可以添加多条消息来构建角色的初始对话场景。',
    '这是第三条消息，展示较长的内容效果。你可以在这里描述更详细的场景、角色的行为、环境氛围等等。内容可以很长，用来展示多行文本的显示和编辑效果。'
  ],
  world_book: {
    name: '角色内嵌世界书',
    entries: [
      {
        ...
        name: '角色背景设定',
        enabled: true,
        content: '这是角色的背景设定内容，可以描述角色的过去、成长经历等信息。',
        mode: 'always',
      ...
      },
      {
        ...
        name: '角色技能',
        enabled: true,
        content: '这个角色拥有特殊的技能和能力，在特定关键词触发时会注入相关信息。',
        mode: 'conditional',
        position: 'system',
        order: 150,
        depth: 1,
