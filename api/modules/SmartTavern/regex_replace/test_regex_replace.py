...
# -*- coding: utf-8 -*-
"""
测试：SmartTavern.regex_replace 模块
- 覆盖两种输入：
...
def test_messages_before_after(rules):
    ...
    res_before = core.call_api("smarttavern/regex_replace/apply_messages", payload_before, method="POST", namespace="modules")
    ...
    res_after = core.call_api("smarttavern/regex_replace/apply_messages", payload_after, method="POST", namespace="modules")
...
def main():
    ...
    demo_res = core.call_api("smarttavern/regex_replace/apply_messages", demo_payload, method="POST", namespace="modules")
