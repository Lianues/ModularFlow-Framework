...
- 人物与画像字段通常来自：
  - character: [backend_projects/SmartTavern/data/characters/*.json](backend_projects/SmartTavern/data/characters/心与露.json)
  - persona: [backend_projects/SmartTavern/data/persona/*.json](backend_projects/SmartTavern/data/persona/用户2.json)
- world_books 与预设说明见：
  - [backend_projects/SmartTavern/data/world_books/参考用main_world.json](backend_projects/SmartTavern/data/world_books/参考用main_world.json)
  - [backend_projects/SmartTavern/data/presets/Default.json](backend_projects/SmartTavern/data/presets/Default.json)
