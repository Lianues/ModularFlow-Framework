...
def main():
    ...
    persona_doc = _read_json("backend_projects/SmartTavern/data/persona/用户2.json")
    ...
    res_raw = core.call_api("smarttavern/framing_prompt/assemble", payload_raw, method="POST", namespace="modules")
    ...
    res_proc = core.call_api("smarttavern/framing_prompt/assemble", payload_processed, method="POST", namespace="modules")
