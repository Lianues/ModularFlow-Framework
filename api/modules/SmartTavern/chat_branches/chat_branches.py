"""
API 封装层：SmartTavern.chat_branches（分支重试对话）
...
@core.register_api(
    path="smarttavern/chat_branches/get_path",
    name="获取当前路径",
...
@core.register_api(
    path="smarttavern/chat_branches/append",
    name="追加楼层",
...
@core.register_api(
    path="smarttavern/chat_branches/truncate",
    name="修剪路径",
...
@core.register_api(
    path="smarttavern/chat_branches/switch",
    name="切换分支并新建会话",
...
@core.register_api(
    path="smarttavern/chat_branches/branch_indicator",
    name="分支指示 j/n",
...
@core.register_api(
    path="smarttavern/chat_branches/list_conversations",
    name="列出对话",
...
@core.register_api(
    path="smarttavern/chat_branches/list_sessions",
    name="列出会话",
...
@core.register_api(
    path="smarttavern/chat_branches/export",
    name="导出对话文件",
...
@core.register_api(
    path="smarttavern/chat_branches/import",
    name="导入对话文件",
