# SmartTraven.python_sandbox 模块说明

位置：api/modules/SmartTraven/python_sandbox/
...
相关代码
- 注册封装层：api/modules/SmartTraven/python_sandbox/python_sandbox.py
- 实现层：api/modules/SmartTraven/python_sandbox/impl.py

API 列表
- smarttraven/python_sandbox/eval（受限求值）
...
参考
- api/modules/SmartTraven/python_sandbox/python_sandbox.py
- api/modules/SmartTraven/python_sandbox/impl.py