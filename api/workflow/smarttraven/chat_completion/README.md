...
result = core.call_api(
    "smarttraven/chat_completion/complete",
    {
        "conversation_file": "backend_projects/SmartTavern/data/conversations/branch_demo.json",
...
const eventSource = new EventSource(
  'http://localhost:8050/api/workflow/smarttraven/chat_completion/complete_stream?' +
  new URLSearchParams({
    conversation_file: 'backend_projects/SmartTavern/data/conversations/branch_demo.json',
    llm_config_file: 'backend_projects/SmartTavern/data/llm_configs/openai_gpt4.json'
  })
